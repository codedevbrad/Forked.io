...
// Import the test function (we'll need to create a non-server version)
async function testR2Upload() {
  try {
    ...
    // Dynamic import to avoid "use server" directive issues
    const { uploadRecipeImageToR2 } = await import("../src/lib/cloudflare/r2");
